...
const formattedRoots = new Set([".github", ".githooks", "infra", "public", "src", "test", "tools"]);
const formattedFiles = new Set(["bunfig.toml", "Dockerfile", "package.json", "README.md", "SECURITY.md", "tsconfig.json"]);
const includeExtensions = new Set([".css", ".html", ".json", ".md", ".toml", ".ts", ".tf", ".yml", ".yaml"]);
